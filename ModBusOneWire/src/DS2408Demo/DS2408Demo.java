	...
	public static void main(String[] args)
	   {
	      ...
	      try
	      {
	    	  /*for (Enumeration owd_enum = OneWireAccessProvider.enumerateAllAdapters(); owd_enum.hasMoreElements();)
		      {
	    		  System.out.println("one adapter found.");
	    		  adapter = ( DSPortAdapter ) owd_enum.nextElement();
	    		  System.out.println("Adapter found: " + adapter.getAdapterName());
		      }*/
	            ...
	            switch (menuSelect(mainMenu))
	            {
	               ...
	               case GET_VCC:
	            	   ...
	            	   for (int o = 0;o < 100;o++)
	            	   {
	            		   ...
	            		   state = owd.readDevice();
	            		   boolean temp= owd.getLevel(0, state);
	            		   temp= owd.getLevel(0, state);
	            		   temp= owd.getLevel(0, state);
	            		   temp= owd.getLevel(0, state);
	            		   ...
	            		   if (temp != input)
	            		   {
	            			   System.out.println("new state : " + temp + ", " + (t2 - t1));
	            			   input = temp;
	            		   }
	            		   
	            		   Thread.sleep(200 - (t2 - t1));
	            	   }
	    ...
	    */
	   public static OneWireContainer3A selectDevice (Vector owd_vect)
	      throws InterruptedException
	   {
	      ...
	      return ( OneWireContainer3A ) owd_vect.elementAt(select);
	   }
